  ...
  return (
    <div>
      ...
      <section className={classes.sectionMarginBottom} id='overview'>
        <p className={classes.title}>FastPay Flutter SDK</p>
        <hr />
      ...
      <section className={classes.sectionMarginBottom} id='installation'>
        ...
        <Alert severity="warning">iOS only supports real device you can't test it on simulator because FastPay SDK not support simulator</Alert>
      </section>
      ...
      <section className={classes.sectionMarginBottom} id='initiate-sdk'>
        ...
        <List component='div' disablePadding>
          ...
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText><strong>IOS callback URI:</strong> IOS callback URI for getting payment info when user pay with Fastpay application.</ListItemText>
          </ListItem>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText><strong>Callback( Sdk status, message, FastpayResult):</strong> There are four sdk status (e.g. <em>FastpayRequest.SDKStatus.INIT</em>) , status message show scurrent status of the SDK and the result is fastpay SDK payment result.</ListItemText>
          </ListItem>
        </List>
        <div className={classes.copyBlockStyle}>
          <CopyBlock language={'dart'} text={sdkStatusCode} showLineNumbers={true} theme={dracula} wrapLines={true} codeBlock />
        </div>
      </section>
      ...
      <section className={classes.sectionMarginBottom} id='examples'>
        ...
        <div className={classes.copyBlockStyle}>
          <CopyBlock language={'dart'} text={initiatePaymentCode} showLineNumbers={true} theme={dracula} wrapLines={true} codeBlock />
        </div>

        <p className={classes.tableTitle}>2. Start the journey by navigating the app to the SDK:</p>
        <div className={classes.copyBlockStyle}>
          <CopyBlock language={'dart'} text={startPaymentCode} showLineNumbers={true} theme={dracula} wrapLines={true} codeBlock />
        </div>
      </section>

      <section className={classes.sectionMarginBottom} id='callback-uri'>
        <p className={classes.title}>SDK callback Uri (IOS only, <em><strong>OPTIONAL</strong></em>)</p>
        <hr />
        <Alert severity="warning">This will reinitiate the whole application with applinks data from the top page of the navigation queue. Thats means, after payment from the fastpay app, it will redirect to your app with the data.</Alert>
        <div className={classes.copyBlockStyle}>
          <CopyBlock language={'dart'} text={callbackHandlingCode} showLineNumbers={true} theme={dracula} wrapLines={true} codeBlock />
        </div>
      </section>
      ...
      <section className={classes.sectionMarginBottom} id='ios-setup'>
        ...
        <hr />
        <p className={classes.detailFontStyle}>
          Add the callback uri to the <code>info.plist</code> file as shown below.
        </p>
        <List component='div' disablePadding>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText>Create URI Create a URI with a unique name (our suggestion is to provide your app name with prefix text "appfpclientFastpayFlutterSdk", for example, if your app name is "FaceLook", your URI should be appfpclientFaceLook)</ListItemText>
          </ListItem>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText>Add URI to your <code>info.plist</code> Now add this URI to your app info.plist file</ListItemText>
          </ListItem>
        </List>
        <div className={classes.copyBlockStyle}>
      ...
      <section className={classes.sectionMarginBottom} id='payment-result'>
        ...
        <List component='div' disablePadding>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText><strong>isSuccess:</strong> return true for a successful transaction else false.</ListItemText>
          </ListItem>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText><strong>errorMessage:</strong> if transaction failed return failed result</ListItemText>
          </ListItem>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText><strong>transactionStatus:</strong> Payment status weather it is success / failed.</ListItemText>
          </ListItem>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
          ...
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText><strong>paymentAmount:</strong> Payment amount for the transaction. “1000”</ListItemText>
          </ListItem>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText><strong>paymentCurrency:</strong> Payment currency for the transaction. (IQD)</ListItemText>
          </ListItem>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText><strong>payeeName:</strong> Payee name for a successful transaction.</ListItemText>
          </ListItem>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText><strong>payeeMobileNumber:</strong> Number: Payee name for a successful transaction.</ListItemText>
          </ListItem>
          <ListItem disableRipple={true} sx={{ pl: 4 }} className={classes.ItemStyle}>
            <ListItemIcon><CircleIcon /></ListItemIcon>
            <ListItemText><strong>paymentTime:</strong> Payment occurrence time as the timestamp.</ListItemText>
          </ListItem>
        </List>
